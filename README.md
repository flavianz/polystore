...
Tendenziell sind diese Daten im `analysis`-Order, gewisse Rohdaten können aber auch noch im `server`-Ordner liegen. Nur
die Rohdateien des ML-Benchmarks fehlen, da diese zu gross für Git und GitHub sind.
