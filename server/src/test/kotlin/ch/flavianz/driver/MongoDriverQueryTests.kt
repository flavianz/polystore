...
class MongoDriverQueryTests {
    ...
    private fun populateData() {
        ...
        d.insertDocument(
            studentsModel,
            aliceId,
            mapOf("name" to "Alice", "gpa" to 4)

        )
        d.insertDocument(
            studentsModel,
            bobId,
            mapOf("name" to "Bob", "gpa" to 3)

        )
        d.insertDocument(
            studentsModel,
            carolId,
            mapOf("name" to "Carol", "gpa" to 2)
        ...
        d.insertDocument(
            enrollmentsModel,
            UUID.randomUUID(),
            mapOf("semester" to "Fall", "grade" to 90), aliceId

        )
        d.insertDocument(
            enrollmentsModel,
            UUID.randomUUID(),
            mapOf("semester" to "Spring", "grade" to 85), aliceId

        )
        d.insertDocument(
            enrollmentsModel,
            UUID.randomUUID(),
            mapOf("semester" to "Fall", "grade" to 70), bobId
        ...
        d.insertDocument(
            coursesModel,
            mathId,
            mapOf("title" to "Math", "credits" to 4)

        )
        d.insertDocument(
            coursesModel,
            historyId,
            mapOf("title" to "History", "credits" to 3)

        )
        d.insertDocument(
            coursesModel,
            physicsId,
            mapOf("title" to "Physics", "credits" to 4)
        ...
        d.insertDocument(
            departmentsModel,
            scienceDeptId,
            mapOf("name" to "Science", "budget" to 500)

        )
        d.insertDocument(
            departmentsModel,
            humanitiesDeptId,
            mapOf("name" to "Humanities", "budget" to 200)
